...
int main() {
	...
	microcode[INSTR_JNZ << 3 | MICROCODE_STEP_0] = PUT_A_ADDR | COND_INVERT | SAVE_PCB_IF_Z;
	microcode[INSTR_JNZ << 3 | MICROCODE_STEP_1] = PC_FLUSH_COND;
	microcode[INSTR_JNZ << 3 | MICROCODE_STEP_2] = FINISH;
	...
	microcode[INSTR_JMP << 3 | MICROCODE_STEP_0] = PUT_A_ADDR | SAVE_PCB;
	microcode[INSTR_JMP << 3 | MICROCODE_STEP_1] = PC_FLUSH;
	microcode[INSTR_JMP << 3 | MICROCODE_STEP_3] = FINISH;

	microcode[INSTR_JZR << 3 | MICROCODE_STEP_0] = PUT_A_ADDR | SAVE_PCB_IF_Z;
	microcode[INSTR_JZR << 3 | MICROCODE_STEP_1] = PC_FLUSH_COND;
	microcode[INSTR_JZR << 3 | MICROCODE_STEP_2] = FINISH;

	microcode[INSTR_LDR << 3 | MICROCODE_STEP_0] = PUT_A_ADDR | SAVE_DB_IR0 | PUT_MEM_DB;
	microcode[INSTR_LDR << 3 | MICROCODE_STEP_1] = FINISH;

	microcode[INSTR_WTR << 3 | MICROCODE_STEP_0] = PUT_A_ADDR | SAVE_DB_MEM | PUT_IR0_DB;
	microcode[INSTR_WTR << 3 | MICROCODE_STEP_1] = FINISH;

	microcode[INSTR_JEQ << 3 | MICROCODE_STEP_0] = PUT_A_ADDR | SAVE_PCB_IF_EQ;
	microcode[INSTR_JEQ << 3 | MICROCODE_STEP_1] = PC_FLUSH_COND;
	microcode[INSTR_JEQ << 3 | MICROCODE_STEP_2] = FINISH;

	microcode[INSTR_JNQ << 3 | MICROCODE_STEP_0] = PUT_A_ADDR | COND_INVERT | SAVE_PCB_IF_EQ;
	microcode[INSTR_JNQ << 3 | MICROCODE_STEP_1] = PC_FLUSH_COND;
	microcode[INSTR_JNQ << 3 | MICROCODE_STEP_2] = FINISH;
